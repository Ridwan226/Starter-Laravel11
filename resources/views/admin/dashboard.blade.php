...
<head>
  ...
  <meta name="description" content="Admin & Dashboard Template Ridwan">
  <meta name="author" content="Ridwan Romadhon">
  <meta name="keywords" content="admin,admin dashboard,admin panel,admin template">
                    ...
                    <div class="browser-stats">
                      <div class="row mb-4">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/chrome.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/opera.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                        <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                          <div class="d-flex align-items-end justify-content-between mb-1">
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/ie.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                        <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                          <div class="d-flex align-items-end justify-content-between mb-1">
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/firefox.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                        <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                          <div class="d-flex align-items-end justify-content-between mb-1">
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/edge.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                        <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                          <div class="d-flex align-items-end justify-content-between mb-1">
                      ...
                      <div class="row mb-4">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/safari.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                        <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                          <div class="d-flex align-items-end justify-content-between mb-1">
                      ...
                      <div class="row">
                        <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                          <img src="{{ asset('/assets/admin/images/browsers/netscape.svg') }}" class="img-fluid"
                            alt="img">
                        </div>
                        <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                          <div class="d-flex align-items-end justify-content-between mb-1">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/10.jpg)"></span>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/12.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                Flower Pot</h6>
                                            </div>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/4.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                Pen Drive</h6>
                                            </div>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/8.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                New Bowl</h6>
                                            </div>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/6.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                Leather Watch</h6>
                                            </div>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/1.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                Digital Camera</h6>
                                            </div>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/11.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                Earphones</h6>
                                            </div>
                                      ...
                                      <tr class="border-bottom">
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <span class="avatar bradius"
                                              style="background-image: url(/assets/admin/images/orders/2.jpg)"></span>
                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                              <h6 class="mb-0 fs-14 fw-semibold">
                                                Shoes</h6>
                                            </div>
            ...
            <div class="tab-pane" id="side2">
              <div class="list-group list-group-flush">
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Addie
                        Minstra</div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Rose Bush
                      </div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Claude
                        Strophobia</div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Eileen
                        Dover</div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Willie
                        Findit</div>
                      <p class="mb-0 fs-12 text-muted"> Okay...I will be waiting for you </p>
                    </a>
                  </div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Manny Jah
                      </div>
                      <p class="mb-0 fs-12 text-muted"> Hi we can explain our new project......
                      </p>
                    </a>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Cherry
                        Blossom</div>
                      <p class="mb-0 fs-12 text-muted"> Hey! there I' am available....</p>
                    </a>
                  </div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Simon
                        Sais</div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Laura
                        Biding</div>
                      <p class="mb-0 fs-12 text-muted"> Hi we can explain our new project......
                      </p>
                    </a>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Ivan
                        Notheridiya</div>
                      <p class="mb-0 fs-12 text-muted"> Hi we can explain our new project......
                      </p>
                    </a>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Dulcie
                        Veeta</div>
                      <p class="mb-0 fs-12 text-muted"> Okay...I will be waiting for you </p>
                    </a>
                  </div>
                ...
                <div class="list-group-item d-flex align-items-center">
                  ...
                  <div class="">
                    <a href="chat.html">
                      <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Florinda
                        Carasco</div>
                      <p class="mb-0 fs-12 text-muted">New product Launching...</p>
                    </a>
                  </div>
          ...
          <div class="modal-body">
            <ul class="row p-3">
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/us_flag.jpg') }}" class="me-3 language"></span>USA
                </a>
              </li>
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/italy_flag.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/spain_flag.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/india_flag.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/french_flag.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/russia_flag.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/germany_flag.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/argentina.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/malaysia.jpg') }}"
              ...
              <li class="col-lg-6 mb-2">
                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                  <span class="country-selector"><img alt=""
                      src="{{ asset('/assets/admin/images/flags/turkey.jpg') }}"
